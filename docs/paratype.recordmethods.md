...
|  --- | --- | --- |
|  [equals(value)](./paratype.recordmethods.equals.md) |  | Determines whether the specified value is equal to the current object. |
...
|  [toData()](./paratype.recordmethods.todata.md) |  | Extracts data from the current object |
